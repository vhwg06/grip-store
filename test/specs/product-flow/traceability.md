...
- `PF-HOME-*`: `test/tests/product-flow/home.spec.ts`
- `PF-CATALOG-*`: `test/tests/product-flow/catalog.spec.ts`
- `PF-DETAIL-*`: `test/tests/product-flow/detail.spec.ts`
- `PF-API-*`: `test/tests/product-flow/api.spec.ts`
