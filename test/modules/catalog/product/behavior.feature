...
Feature: Catalog product administration
  ...
  Rule: Product administration reads are protected and expose operator health signals
    ...
    @accepted @api @security @SC-CAT-PRODUCT-READ-001
    ...
    @accepted @api @security @SC-CAT-PRODUCT-READ-002
    ...
    @accepted @api @SC-CAT-PRODUCT-READ-003
    ...
    @accepted @api @SC-CAT-PRODUCT-READ-004
  ...
  Rule: Product administration persists the complete commercial product contract
    ...
    @accepted @api @SC-CAT-PRODUCT-COMMAND-001
    ...
    @accepted @api @SC-CAT-PRODUCT-COMMAND-002
    ...
    @accepted @api @SC-CAT-PRODUCT-COMMAND-003
    ...
    @accepted @api @SC-CAT-PRODUCT-COMMAND-004
    ...
    @accepted @api @SC-CAT-PRODUCT-COMMAND-005
  ...
  Rule: Product detail persistence is transactional and visible through public read models
    ...
    @accepted @api @SC-CAT-PRODUCT-DETAILS-001
    ...
    @accepted @api @SC-CAT-PRODUCT-DETAILS-002
    ...
    @accepted @api @SC-CAT-PRODUCT-DETAILS-003
